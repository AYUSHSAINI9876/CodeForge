  ...
  useEffect(() => {
    const fetchRepoAndIssues = async () => {
      try {
        ...
        // Handle both array and object responses (some Mongoose queries return arrays)
        if (Array.isArray(repoRes.data) && repoRes.data.length > 0) {
          setRepo(repoRes.data[0]);
        } else if (repoRes.data && !Array.isArray(repoRes.data) && repoRes.data._id) {
          setRepo(repoRes.data);
        } else {
          setErrorMsg("Repository not found. It may have been deleted or moved.");
        }
        ...
        setErrorMsg("Unable to load repository. Please check your connection.");
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="repo-detail-container">
        ...
        <div className="repo-header">
          <div className="repo-title-wrapper">
            <h1>
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
              {repo.name} 
          ...
          <div className="repo-actions">
            <button className="action-btn">
              ...
              Star <span className="repo-tab-count">{stats.stars}</span>
            </button>
              ...
              <div className="file-browser">
                <div className="file-browser-header">
                  <div className="commit-info">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="4"></circle><line x1="1.05" y1="12" x2="7" y2="12"></line><line x1="17.01" y1="12" x2="22.96" y2="12"></line></svg>
                    <strong>main</strong>
                    <span style={{color: "var(--text-muted)", marginLeft: "8px"}}>Latest commit message here...</span>
                  </div>
                  <span style={{fontSize: "0.85rem"}}>Updated 2 days ago</span>
                </div>
                ...
                <div className="issue-list">
                  {issues.map(issue => (
                    <div className="issue-item" key={issue._id}>
                      <svg className={`issue-icon ${issue.status === 'closed' ? 'closed' : ''}`} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                      <div>
